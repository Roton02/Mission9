    ...
    <div className="animate__animated animate__fadeInLeft  animate__delay-1s  text-center  lg:ml-32 lg:text-left border-2 px-5 md:px-10 lg:px-16 py-10 rounded-xl bg-opacity-60 bg-gray-500 ">
      ...
      <div className="  px-4 py-2 space-y-2">
        ...
        <div className=" flex items-center gap-10 ">
            <Link to='/blog'><button  className="btn bg-slate-100 border-pink-600 hover:bg-pink-600 transition  text-pink-600   duration-500  hover:text-white"> <span className="px-4"> Blog</span> </button></Link>
            <Link to="/profile">
    ...
    <div className="animate__animated animate__fadeInRight animate__delay-1s   card shrink-0 w-full max-w-sm border-2 py-10 bg-opacity-60 bg-gray-500">
      <form onSubmit={handleSubmit}  className="card-body">
        <div className="form-control">
          ...
          <input defaultValue={displayName} type="text" required name="name" placeholder="Enter your update Name" className="input input-bordered"  />
        </div>
        <div className="form-control">
          <label className="label">
