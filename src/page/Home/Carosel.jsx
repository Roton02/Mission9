...
const Carosel = () => {
  ...
  return (
    <div className="w-full h-[550px] md:h-[650px] lg:h-screen rounded-2xl flex flex-col xl:flex-row items-center justify-center gap-5 lg:gap-10 relative bg-cover before:absolute  before:inset-0 transform duration-1000 ease-linear z-50 overflow-hidden"
